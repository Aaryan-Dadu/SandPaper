...
class SelectorExtractor:
    ...
    def __init__(
        ...
        self._compiled: dict[str, tuple[str, str | None]] = {}
    ...
    def _extract_flat(self, soup, source_url: str | None) -> ExtractedTable:
    ...
    def _extract_row_scoped(self, soup, source_url: str | None) -> ExtractedTable:
        try:
    ...
    def _read_value(self, el, attr: str | None) -> str:
        if el is None:
            return ""
        if attr:
            val = el.get(attr)
    ...
    def extract_one(self, html: str, source_url: str | None = None) -> dict[str, str]:
